...
title("Trajectory")
size = 500;
pitch = ones([1,size]).*15;
az = linspace(0,360,size);
input = [az',pitch'];
CaptureFigVid(input,"trajectory")
...
%% Plot roational velocity
p = table2array(Sphereout(:,"prads"));
q = table2array(Sphereout(:,"qrads"));
r = table2array(Sphereout(:,"rrads"));
t = table2array(Sphereout(:,"Times"));
figure, plot(t,p,DisplayName="p"); hold on
